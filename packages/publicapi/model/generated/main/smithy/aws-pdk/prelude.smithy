...
metadata validators = [
    
    {
      ...
      configuration: {
          bindToTrait: com.newwwie#handler
          selector: """
              :not([@trait|com.newwwie#handler: @{language} = typescript, java, python])
          """
          messageTemplate: """
              @{trait|com.newwwie#handler|language} is not supported by type-safe-api.
    ...
    
    {
      ...
      configuration: {
          bindToTrait: com.newwwie#handler
          selector: """
              [@trait|com.newwwie#handler: @{language} = typescript, java, python]
              :not([@trait|com.newwwie#handler: @{language} = typescript])
          """
          messageTemplate: """
              @@handler language @{trait|com.newwwie#handler|language} cannot be referenced unless a handler project is configured for this language.
